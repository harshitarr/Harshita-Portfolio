              ...
              <div className="p-6 md:p-8">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  <a
                    ...
                    className="flex-1 bg-gray-800 hover:bg-purple-800 text-gray-400 px-4 py-2 rounded-xl text-sm md:text-lg font-semibold text-center"
                  >
                    View Code
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-purple-600 hover:bg-purple-800 text-white px-4 py-2 rounded-xl text-sm md:text-lg font-semibold text-center"
                  >
                    View Live
                  </a>
                </div>
